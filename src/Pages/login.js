...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("user")) {  //if user login before
    ...
    if (loading) {
      ...
      setLoading(<button className="button">{t('sigin')}</button>);
    }
  ...
  return (
    <div className="sign-in">
      ...
      <div className="logo-form">
        <div className="logo">
          <img className="logo-chef" src="/icons/chef.png" alt="" />
          <div>{t('logo')}</div>
        </div>
